...
Think of project-specific testing like testing a custom feature:

- **Window Aggregation Test** = Test Job 1: "Does it calculate signals correctly?"
- **Join Test** = Test Job 3: "Does it join signals and prices correctly?"
- **Lag Detection Test** = Test core logic: "Does it detect lag correctly?"

**Why Needed**: MarketLag has specific business logic that needs targeted testing.

---

## Analogy

If you know **functional testing** (which you do), project-specific testing is similar:
- Functional tests = Project-specific tests (both test business logic)
- Test cases = Specific scenarios (both test specific functionality)

Key difference: Project-specific tests are tailored to MarketLag's unique logic.
